...
import com.xyz.fch_sp.app.core.sms.SmsChannelTemplateEnum;
...
public interface IUserService extends IService<User> {
    ...
    List<Map<String, Object>> selectPageUsers(Page<User> page, DataScope dataScope, String name, String beginTime, String endTime, Integer deptid);
