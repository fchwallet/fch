 ...
 */
package com.xyz.fch_sp.app.modular.system.factory;

import com.xyz.fch_sp.app.modular.system.model.User;
import com.xyz.fch_sp.app.modular.api.dto.RegistDto;
...
public class UserFactory {
    public static User createUser(RegistDto registDto) {
        if (registDto == null) {
            return null;
        } else {
            User user = new User();
            BeanUtils.copyProperties(registDto, user);
            return user;
        }
    }
