package com.xyz.fch_sp.app.core.websocket;
...
public class SocketSessionRegistry{
    ...
    public void registerSessionId(String user, String sessionId) {
        log.info("registerSessionId");
        log.info("user:"+user+" sessionId:"+sessionId);
        ...
        synchronized(this.lock) {
            ...
            log.info("user:"+user+" size:"+set.size());
        }

        log.info("userSessionIds size:"+userSessionIds.size());
    }

    public void unregisterSessionId(String user, String sessionId) {
        log.info("unregisterSessionId");
        log.info("user:"+user+" sessionId:"+sessionId);
